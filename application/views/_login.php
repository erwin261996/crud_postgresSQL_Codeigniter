...
<body>
	...
	<div class="container">
		...
		<?php echo form_open("Login/acceder", array("class"=>"form-online", "id"=>"frm_login", "name"=>"frm_login", "method"=>"POST")); ?>
		  ...
		  <a href="<?php echo base_url().'/Register'; ?>">Registrar Usuario</a>
		<?php echo form_close(); ?>
	...
	<!-- <script src="<?php //echo HTTP_JS_PATH; ?>login.js"></script> -->
